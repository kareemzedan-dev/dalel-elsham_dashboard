...
class DalelElshamTabViewBody extends StatelessWidget {
        ...
        child: SafeArea(
          ...
          children: [
              ...
              child: BlocBuilder<
                ...
                builder: (context, state) {
                  if (state is GetBannersByPositionViewModelStatesSuccess &&
                    ...
                    return SponsoredBanner(image: state.banners.first.imageUrl);
                  }
            ...
            BlocProvider(
              ...
              child: const FeaturedPlaceCardList(),
            ),
  ...
  void _openAddPlaceBottomSheet(BuildContext context) {
    showModalBottomSheet(
      context: context,
      isScrollControlled: true,
      builder: (_) {
        return BlocProvider(
            create: (context) => getIt<AddPlaceViewModel>(),
